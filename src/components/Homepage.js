        ...
        <div className="container">
          <div className="filters">
            <input
              ...
              style={{
                backgroundImage: `url(${
                  this.props.theme ? search_light : search_dark
                })`,
              }}
            />
            <Dropdown
              region={this.state.region}
              regionBtn={this.regionBtn}
                ...
                <li className="card" key={country.alpha3Code}>
                  ...
                  <div className="card__text">
                    <Link
                      ...
                      to={{ pathname: country.alpha3Code }}
                    >
                      {country.name}
                    </Link>
                    <ul>
                      <li className="card__properties">
                        <span className="card__bold">Population: </span>
                        {country.population.toLocaleString("en-US")}
                      </li>
                      <li className="card__properties">
                        <span className="card__bold">Region: </span>
                        {country.region}
                      </li>
                      <li className="card__properties">
                        <span className="card__bold">Capital: </span>
                        {country.capital}
                      </li>
                    </ul>
                  </div>
