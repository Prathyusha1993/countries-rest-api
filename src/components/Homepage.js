        ...
        <div className="homepage">
            <div className="container">
                <div className="filters">
                    <input id="search" name="search" onChange={this.onChange} className="search" placeholder="Search for a country…"
                    style={{ backgroundImage: `url(${this.props.theme ? search_light : search_dark})` }}/>
                    ...
                    {filteredCountries.map(country => (
                        <li className="card" key={country.alpha3Code}>
                            ...
                            <div className="card__text">
                                <Link className="card__link" to={{pathname:country.alpha3Code}}>{country.name}</Link>
                                <ul>
